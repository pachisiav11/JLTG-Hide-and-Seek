...
export const DEFAULT_SETTINGS = {
  ...
  // How far from a station a hider may be — a RULE the group is playing, not a display
  // setting. Nothing is drawn for it: the zone overlay that used to visualise it was removed
